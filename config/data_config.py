...
bpic_2018_dict = dict({'bpi_path' : os.path.join(path, 'data', 'BPIC2018'),
                       ...
                       'static_cat_cols': list(['case:young farmer','case:penalty_AJLP','case:small farmer',
                                                ...
                                                'case:redistribution', 'case:penalty_JLP6',
                                                'case:penalty_JLP7', 'case:penalty_JLP5', 'case:penalty_JLP2',
                                                'case:penalty_JLP3', 'case:penalty_JLP1']),
                       'dynamic_cat_cols': list(['org:resource', 'concept:name', 'success',  'subprocess',
                                                 'note',]),
                       'num_cols': list(['case:penalty_amount0','case:penalty_amount1','case:penalty_amount2','case:penalty_amount3',
                                         'month', 'weekday', 'hour', 'time_since_first_event',  'time_since_last_event',
                                         'case:amount_applied0', 'case:amount_applied1', 'case:amount_applied2',
                                         'case:amount_applied3','case:number_parcels',
                                         'case:area', 'case:payment_actual0', 'case:payment_actual1',
